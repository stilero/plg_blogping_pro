...
class StileroBPPJarticle {
    ...
    public function __construct($article) {
        ...
        $tempClass->jVersion = StileroBPPJVersionHelper::jVersion();
    ...
    public function url($article){
        ...
        if($hasSH404SEF){
            $url = StileroBPPSH404SEFUrlHelper::sefURL($articleSlug, $categorySlug);
        }else{
            $url = StileroBPPUrlHelper::sefURL($articleSlug, $categorySlug);
        }
        return $url;
    }
    ...
    protected function image($Article){
        return StileroBPPJArticleImageHelper::image($Article);
    }
    ...
    protected function firstContentImage($Article){
        return StileroBPPJArticleImageHelper::firstImageInContent($Article);
    }
    ...
    protected function introImage($Article){
        return StileroBPPJArticleImageHelper::imageFromTextType($Article, StileroBPPJArticleImageHelper::IMAGE_TYPE_INTRO);
    }
    ...
    protected function fullTextImage($Article){
        return StileroBPPJArticleImageHelper::imageFromTextType($Article, StileroBPPJArticleImageHelper::IMAGE_TYPE_FULL);
    }
    ...
    protected function images($Article){
        return StileroBPPJArticleImageHelper::imagesInContent($Article);
    }
...
class StileroBPPK2Article extends StileroBPPJarticle {
     ...
     */
    public function url($Article) {
        return StileroBPPK2UrlHelper::sefURL($Article);
    }
